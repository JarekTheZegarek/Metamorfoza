#ifndef metamorfozis_w5H
#define metamorfozis_w5H
...
extern const crCursorMagnPlus ;
extern const crCursorMagnMinus ;
...
int DajPunktBMin(int NrP);
 ...
 void ZapisSesji(int Wersja);       //Zapis Sesji w danej wersji
...
double Konwertuj(double Wart);  // wykonuje konwersji wartosci odczytanej z nazwy do odpowiedniej liczby.
                                // implementacja w Eksport.cpp
//---------------------------------------------------------------------------
#endif
